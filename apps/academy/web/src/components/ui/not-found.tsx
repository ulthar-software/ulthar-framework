...
export interface NotFoundProps {
  /**
   * Título personalizado para la página de error.
   ...
   * @default "La página que estás buscando no existe o no está disponible."
   */
  message?: string;
...
export function NotFoundPage({
  ...
  message = "La página que estás buscando no existe o no está disponible.",
  className,
}: NotFoundProps) {
