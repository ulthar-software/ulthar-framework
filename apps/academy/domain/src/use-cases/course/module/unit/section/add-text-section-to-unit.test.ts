...
import { AddTextSectionToUnitUseCase } from "./add-text-section-to-unit.js";

describe("Add Text Section To Unit Use Case", () => {
  ...
  test("Admin should successfully add a text section to a unit", async () => {
    // Arrange
    const sectionData = {
  ...
  test("Section order should increment correctly when multiple sections are added", async () => {
    ...
    const firstSectionData = {
      ...
      text: "This is the first text section.",
    };
  ...
  test("Should fail when adding a section to a non-existent unit", async () => {
    ...
    const sectionData = {
      ...
      title: "Invalid Unit Text",
      text: "This text is for a non-existent unit.",
    };
  ...
  test("Should fail when user lacks EDIT_COURSE permission", async () => {
    ...
    const sectionData = {
      ...
      text: "This text shouldn't be added due to lack of permissions.",
    };
