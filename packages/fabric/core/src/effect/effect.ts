...
import type { MergeTypes } from "../types/merge-types.js";
...
> {
  ...
  static ok<TValue>(value?: TValue): Effect {
  ...
  flatMap<TNewValue, TNewError extends TaggedError, TNewDeps = void>(
    ...
    }) as Effect<TNewValue, TError | TNewError, MergeTypes<TDeps, TNewDeps>>;
  }
...
export type ExtractEffectDependencies<T> =
  T extends Effect<any, any, infer TDeps> ? TDeps : never;
