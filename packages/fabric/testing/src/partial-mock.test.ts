import { fnMock } from "./fn-mock.js";
import { describe, expect, test } from "./index.js";
import { partialMock } from "./partial-mock.js";
...
describe("partialMock", () => {
  ...
  test("given a type with multiple properties, should create a mock with only some properties", () => {
